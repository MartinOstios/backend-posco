...
def update_user_me(
    *, session: SessionDep, user_in: UserUpdateMe, current_user: CurrentUser
    ...
    db_user = crud.update_user(session=session, db_user=current_user, user_in=user_in)
    return db_user
...
def delete_user_me(session: SessionDep, current_user: CurrentUser) -> Any:
    ...
    crud.delete_user(session=session, current_user=current_user)
...
def delete_user(
    ...
    crud.delete_user(session=session, current_user=user)
    return Message(message="User deleted successfully")
